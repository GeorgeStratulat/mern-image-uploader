...
const composeEnhancers = redux_devtools_extension_1.composeWithDevTools({ trace: true }); //allows tracing
const store = redux_1.createStore(reducers_1.reducers, composeEnhancers(redux_1.applyMiddleware(...middleware)));
exports.axiosURL = "";
