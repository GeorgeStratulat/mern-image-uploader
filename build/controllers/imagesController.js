...
exports.imagesController.post("/add", upload.single("image"), function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var user;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, Users_1.Users.findByIdAndUpdate(req.session.user._id, {
                        $push: {
